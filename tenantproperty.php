...
<html>
	...
	<?php
		...
		$id=$_REQUEST['id'];
		//echo "$id";
		$q="select id,name,photo,address,price,area,status,moreinfo,photo1,photo2,photo3,photo4 from addproperty where id='$id'";
		...
		while($row=mysqli_fetch_array($r))
		{
			...
			<span style="float:inherit"><button style="background-color: #2196F3;width:150px;height: 50px;font-size: 20px;">';
		echo "<a href=\"pyt.php?id=$id\">Book for Rent</a></button></span>";
		}
	?>
    </center>
    </body>
